...
class SysTrayIcon(object):
    ...
    def refresh_icon(self):
        ...
        if os.path.isfile(self.icon):
            ...
            print hinst, self.icon, win32con.IMAGE_ICON, win32con.IMAGE_BITMAP, icon_flags
    ...
    def prep_menu_icon(self, icon):
        ...
        print icon, win32con.IMAGE_ICON, win32con.IMAGE_BITMAP, ico_x, ico_y, win32con.LR_LOADFROMFILE
        hicon = win32gui.LoadImage(0, icon, win32con.IMAGE_BITMAP, ico_x, ico_y, win32con.LR_LOADFROMFILE)
        print hicon
